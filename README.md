...
![Tests](https://img.shields.io/badge/tests-335%20passing-2ea44f)
...
| Web unit | 41 | Error mapping, relative time, status verbs, the shell, theme switching, the filter query string. |
| End to end | 6 | A browser signing in, opening a request, triaging it, commenting; the customer and admin views; filters surviving every route back to the list. |

335 in total, all green in CI on every push.
